...
class CustomTableViewCell: UITableViewCell {
    ...
    var tensSliderContainer:SliderLabelContainer = SliderLabelContainer(frame: CGRectMake(6, 22, 35, 45), type: SliderLabelContainerType.TensDigitType,fontsize:54,color:UIColor.redColor())
    var singleSliderContainer:SliderLabelContainer = SliderLabelContainer(frame: CGRectMake(34, 22, 36, 45), type: SliderLabelContainerType.SingleDigitType,fontsize:54,color:UIColor.redColor())
    ...
    override func layoutSubviews() {
        ...
        singleStudentConatiner.removeFromSuperview()
